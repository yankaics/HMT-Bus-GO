			...
			<div id="progress-embeded" class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbar-collapse">
					<nav class="nav navbar-nav">
						<li><a href="./index.php"><span class="fa fa-map"></span> 校巴地图</a></li>
						<li><a href="./index.php?mod=lineindex"><span class="fa fa-bus"></span> 校巴线路查询</a></li>
						<li><a href="./index.php?mod=stopindex"><span class="fa fa-map-marker"></span> 校巴站点查询</a></li>
						<li><a id="toggle-wxss-qrcode" data-pjax="no-pjax" href="javascript:;"><span class="fa fa-weixin"></span> 获取微信小程序</a></li>
